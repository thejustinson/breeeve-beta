...
export default function Onboarding() {
  ...
  const handleUsernameChange = async (value: string) => {
    ...
    // TODO: Add actual username availability check
            ...
            <div className="flex-1 min-w-[320px]">
              <AnimatePresence mode="wait">
                {currentStep === 1 && (
                  ...
                  >
                    ...
                    <div className="space-y-2 w-full">
                      ...
                      <div className="">
                        {formData.username && (
                          <p className={`text-sm ${isUsernameAvailable ? 'text-green-600' : 'text-red-600'}`}>
                            {isUsernameAvailable 
                ...
                {currentStep === 2 && (
                  ...
                  >
                    <div>
                      <h2 className="text-xl font-semibold text-gray-900">Add your email</h2>
                      <p className="mt-1 text-sm text-gray-500">
                        Get notified about incoming payments
                      </p>
                    </div>
